...
rIdot = vI;
vIdot = ([0;0;-mq*gE] + RBI'*sum(FMat,2) + distVec ...
    - 1/2*P.quadParams.Cd*P.quadParams.Ad*P.constants.rho ...
    * dot(RBI'*[0 0 1]',vI)*vI)/mq;
RBIdot = -omegaBx*RBI;
NB = sum(NMat,2);
for ii=1:4
...
omegaVecdot = 1./P.quadParams.taum .* (P.quadParams.cm .* eaVec - omegaVec);
